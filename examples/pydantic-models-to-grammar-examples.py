...
import importlib
from pydantic_models_to_grammar import generate_gbnf_grammar_and_documentation, create_dynamic_model_from_function, convert_dictionary_to_pydantic_model, add_run_method_to_dynamic_model
...
# An example structured output based on pydantic models. The LLM will create an entry for a Book database out of an unstructured text.
class Category(Enum):
    """
